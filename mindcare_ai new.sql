...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 12, 2025 at 03:40 PM
...
INSERT INTO `emergency_numbers` (`id`, `name`, `contact_number`, `logo`) VALUES
(1, 'Hopeline', 'Globe: (0917) 558 4673', 'uploads/emergency/1754919485_Screenshot 2025-08-11 162338.png'),
(2, 'HCC GCSD', '(0930) 499 9331', 'uploads/emergency/1754919545_Screenshot 2025-08-11 113448.png');
...
INSERT INTO `facebook_pages` (`id`, `name`, `page_link`, `logo`) VALUES
(1, 'Holy Cross College Guidance and Counseling Services Division ', 'https://www.facebook.com/hccguidanceandcounselingservicesdivision', 'uploads/facebook/1754919408_hcc.jpg');
...
--
ALTER TABLE `exam_answers`
  ADD CONSTRAINT `exam_answers_ibfk_1` FOREIGN KEY (`result_id`) REFERENCES `exam_results` (`id`) ON DELETE CASCADE,
...
ALTER TABLE `exam_results`
  ...
  ADD CONSTRAINT `exam_results_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
